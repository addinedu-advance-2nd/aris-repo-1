...
# 신규 회원 케이스
# 1. 신규 회원 김모모, 바나나맛 아이스크림, 토핑 1번 구매
datetime_order = datetime.datetime.now()
members_number_MM = add_new_member(datetime_order, name='김모모', phone='01012341234')
update_order_history(datetime_now=datetime_order, flavor='Banana', toppings='100', membership_n=members_number_MM)
print(members_number_MM)

# 2. 신규 회원 이현수, 초코 아이스크림, 토핑 1번, 2번 구매
datetime_order = datetime.datetime.now()
members_number_HS = add_new_member(datetime_order, name='이현수', phone='01098765432')
...
datetime_order = datetime.datetime.now()
members_number_SH = add_new_member(datetime_order, name='박소현', phone='01045678912')
...
datetime_order = datetime.datetime.now()
members_number_MS = add_new_member(datetime_order, name='최민수', phone='01078912345')
...
# 5. 신규 회원 김지연, 바나나맛 아이스크림, 토핑 1번과 2번 구매
datetime_order = datetime.datetime.now()
members_number_JY = add_new_member(datetime_order, name='김지연', phone='01032165498')
update_order_history(datetime_now=datetime_order, flavor='Banana', toppings='110', 
                     membership_n=members_number_JY)
print(members_number_JY)

# 6. 신규 회원 장우진, 딸기 아이스크림, 토핑 없음 구매
datetime_order = datetime.datetime.now()
members_number_UJ = add_new_member(datetime_order, name='장우진', phone='01065412398')
...
# 8. 기존 회원 이현수, 바나나맛 아이스크림, 토핑 2번 구매
datetime_order = datetime.datetime.now()
members_number = members_number_HS
update_order_history(datetime_now=datetime_order, flavor='Banana', toppings='010', membership_n=members_number)
print(members_number)
...
# . 기존 회원 김지연, 바나나맛 아이스크림, 토핑 1번과 3번 구매
datetime_order = datetime.datetime.now()
members_number = members_number_JY
update_order_history(datetime_now=datetime_order, flavor='Banana', toppings='101', membership_n=members_number)
print(members_number)
...
# . 비회원, 바나나맛 아이스크림, 토핑 1번, 3번 구매
datetime_order = datetime.datetime.now()
update_order_history(datetime_now=datetime_order, flavor='Banana', toppings='101', membership_n="None")
...
# . 비회원, 초코 아이스크림, 토핑 1번 구매
datetime_order = datetime.datetime.now()
update_order_history(datetime_now=datetime_order, flavor='Chocolate', toppings='100')
...
# . 비회원, 바나나맛 아이스크림, 토핑 1번, 3번 구매
datetime_order = datetime.datetime.now()
update_order_history(datetime_now=datetime_order, flavor='Banana', toppings='101')

# . 비회원, 바나나맛 아이스크림, 토핑 1번, 3번 구매
datetime_order = datetime.datetime.now()
update_order_history(datetime_now=datetime_order, flavor='Banana', toppings='101')

# . 기존 회원 박소현, 바나나 아이스크림, 토핑 없음 구매
datetime_order = datetime.datetime.now()
members_number = members_number_SH
update_order_history(datetime_now=datetime_order, flavor='Banana', toppings='000', membership_n=members_number)
print(members_number)
